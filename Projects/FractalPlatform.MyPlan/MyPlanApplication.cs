...
namespace FractalPlatform.MyPlan 
{
    ...
    public class MyPlanApplication: BaseApplication 
    {
        ...
        private void Today(bool isYesterday = false, bool isBeforeYesterday = false)
        {
            DateTime now;
            ...
            doc.OpenForm(result => 
            {
                if(result.Result)
                {
                    ...
                    AddReport(repeat, never, once, week, month, year, isYesterday, isBeforeYesterday);
                }
                else
                {
                    Dashboard();
        ...
        public override bool OnEventDimension(EventInfo info)
        {
            ...
            switch(path)
            {
                ...
                case @"Schedule":
                {
                    ...
                    DocsWhere("Schedule","{'DayOfWeek':@DayOfWeek}", dayOfWeek)
                        .OpenForm();
