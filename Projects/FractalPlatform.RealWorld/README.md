...
### [Demo](https://booben.com/jupiter/RealWorld)&nbsp;&nbsp;&nbsp;&nbsp;[RealWorld](https://github.com/gothinkster/realworld)
...
We created special [RealWorldComparator](https://booben.com/jupiter/RealWorldComparator) web app 
...
[Fractal Platform](https://github.com/fraplat/FractalPlatform) is low code platform to build [numerous](https://booben.com/jupiter/ListOfProjects) different web applications with clean architecture in short time.
...
- **Less code**. Web applications contain approximately [~5-50 less of code](https://booben.com/jupiter/RealWorldComparator) than typical web solutions.
...
- Run [FractalPlatform.Deployment](https://github.com/fraplat/FractalPlatform/tree/main/FractalPlatform.Deployment) project to deploy RealWorld application in Fractal Cloud.
  After deploying RealWorld application will be opened in the your default web browser as https://booben.com/jupiter/RealWorld.
